...
class StatusLengthTest(
    ...
    fun statusLength_matchesExpectations() {
        ...
        assertEquals(
            expectedLength,
            ComposeActivity.statusLength(spannedText, null, false, SpanUtilsTest.FakeSpannable(""), 23)
        )
    }
    ...
    fun statusLength_withCwText_matchesExpectations() {
        ...
        assertEquals(
            ...
            ComposeActivity.statusLength(spannedText, cwText, false, SpanUtilsTest.FakeSpannable(""), 23)
        )
    }
}
